...
const config: Config = {
  ...
  // organizationName: 'tupui', // Usually your GitHub org/user name.
  // projectName: 'company_website', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      //   },
      // ],
      copyright: `Copyright © ${new Date().getFullYear()} Consulting Manao GmbH.`,
    },
    prism: {
